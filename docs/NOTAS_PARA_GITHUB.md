...
- Escopo definido: v0.8.1 com Setup_Nexus.exe, Nexus_AI_Pro.exe e PhoenixDub_Update.zip; aguardando validação do build.
...
- Atualizar README.md e RELEASE_NOTES.md para a versão escolhida; versão ajustada para v0.8.1 neste worktree.
