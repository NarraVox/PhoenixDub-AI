...
video_path = "C:/Users/Paulo Henrik/Videos/video editado 2 .mp4"
scratch_dir = Path("C:/IA_dublagem/scratch")
scratch_dir.mkdir(exist_ok=True)
output_txt = scratch_dir / "transcricao_video_editado_2.txt"
...
try:
    ...
    with open(output_txt, "w", encoding="utf-8") as f:
        f.write(f"Transcrição do Vídeo Editado 2: {Path(video_path).name}\n")
    ...
    print(f"Erro ao transcrever o vídeo editado 2: {e}")
